...
public class ExtentReport implements IReporter {
    //生成的路径以及文件名
    private static final String OUTPUT_FOLDER = "TestOutput/ExtentReport/";
...
//                    resultNode.getModel().setName(suite.getName()+" : "+r.getTestContext().getName());
    ...
    private void init() {
        ...
        htmlReporter.config().setDocumentTitle("销售服务系统测试报告");
        htmlReporter.config().setReportName("销售服务系统测试报告");
...
//                 	    String AppointDir =CurrentDir+"\\BugScreenshot\\";
            	        ...
            	        test.addScreenCaptureFromPath(AppointDir+result.getMethod().getMethodName()+".png");
					} catch (IOException e) {
						e.printStackTrace();
					}
